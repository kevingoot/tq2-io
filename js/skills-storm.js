...
(function () {
  ...
  window.TQ2.skills.storm = {
    source: "Client screenshots 2026-09-25 (full inspect pass). 10 actives + 21 passives. Layout is bottom→up L→R same as Earth/Rogue (tier I first). Actives 2-3-3-2. Passives 2-5-4-5-5. Ice Shards extra modifier capacity (I–V). 0-point inspect except Ice Shards already invested.",
    layout: {
      actives: [
