window.TQ2 = {
  ...
  bosses: [
    ...
    { id: "pan", name: "Pan", title: "God of the Wild", act: 1, actName: "Act 1 \u2014 Flooded Farmlands", remnant: "Pan's Horn", remnantConfirmed: true, zone: "Pan's Sanctum", waypoint: "Pan's Sanctum", image: "img/Pan.jpg", kind: "story", samples: [{ id: "pan-55-0", label: "55 +0", status: "closed", kills: 100, date: "2026-09-23", gold: "11k-18k", epics: 5, infrequents: 11, infrequentAttribution: "zone-likely", namedEssences: 8, notes: "Header infrequents (11/100) are pile greens — likely Act 1 world/zone drops, not proven Pan-specific. Best keep: Chromatic Staff.", drops: [{ item: "captains-signet", count: 2 }, { item: "thorny-maul", count: 1 }, { item: "chromatic-staff", count: 1 }, { item: "ram-bow-ii", count: 1 }, { item: "essence-apollo", count: 2 }, { item: "essence-zeus", count: 1 }, { item: "essence-hypnos", count: 2 }, { item: "essence-aegis-athena", count: 1 }, { item: "essence-hera-scepter", count: 1 }, { item: "essence-typhon-fang", count: 1 }, { item: "empowered-pyromancer-sword", count: 1, flag: "off-table" }] }] },
